...
import ArchiveReminders from './components/reminders/ArchiveReminders.vue';
import ViewArchiveReminder from './components/reminders/ViewArchiveReminder.vue';
...
const routes = [
    ...
    {path: '/archives', component: ArchiveReminders, name: 'archiveReminders'},
    {path: '/archives/view/:id', component: ViewArchiveReminder, name: 'viewArchiveReminder'},
