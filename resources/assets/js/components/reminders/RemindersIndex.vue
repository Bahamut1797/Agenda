<template>
    <div>
        ...
        <div class="form-group">
            <router-link :to="{name: 'createReminder'}" class="btn btn-success">Create new reminder</router-link> <router-link :to="{name: 'archiveReminders'}" class="btn btn-primary pull-right">Archive reminders</router-link>
        </div>
 
        <div class="panel panel-default">
            <div class="panel-heading"> <p id="myElement">Active list</p> </div>
