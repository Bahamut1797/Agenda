<template>
    <div>
        ...
        <div class="form-group">
            <router-link :to="{name: 'createReminder'}" class="btn btn-success">Create new reminder</router-link> <router-link :to="{name: 'remindersIndex'}" class="btn btn-primary pull-right">Back</router-link>
        </div>
            ...
            <div class="panel-body">
                ...
                <table v-if="!loading" class="table table-bordered table-striped">
                    ...
                    <tr v-for="(reminder, index) in reminders" :key="reminder.id">
                        ...
                        <td>
                            <router-link :to="{name: 'viewArchiveReminder', params: {id: reminder.id}}" class="btn btn-xs btn-default">
                                View
                            </router-link>
                            <a href="#"
...
<script>
    export default {
        ...
        mounted() {
            var app = this;
            app.loading = true;
            axios.get('/api/v1/archive_reminders')
                .then(function (resp) {
                    app.loading = false;
        ...
        methods: {
            ...
            deleteEntry() {
                var app = this;
                axios.delete('/api/v1/archive_reminders/' + app.reminderId)
                    .then(function (resp) {
